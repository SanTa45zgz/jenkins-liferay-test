...
<#assign categProperLocalService	= serviceLocator.findService( "com.liferay.asset.category.property.service.AssetCategoryPropertyLocalService" ) >
									...
									<#if phaseIsProcSelectivo >
										...
										<#if phase_info_state_location?has_content >
											...
											<#if infoProcSelStartDateStr?has_content >
												...
												<#-- Si la hora o el minuto es 04 nos llega solo 4 as� que hay que arreglarlo -->
