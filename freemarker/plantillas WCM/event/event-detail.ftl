...
<#if eventType != "" >
	<#if eventType != "upv-ehu-other"  && eventType != "upv-ehu-blank"  >
...
<#if eventScope != "" >
	<#if eventScope != "upv-ehu-other"  && eventScope != "upv-ehu-blank"  >
...
<article class="${ articleClass }">
	...
	<h1 class="${ titleClass }">
							...
							<#if entGeneralData.ehudayhours.initendhour?? >
								...
								<#list currentehudayhours.initendhour.getSiblings() as currentinitendhour >
										...
										<#if ehuday != "" >
											...
											<#if inithour?has_content && inithour?? && inithour != "[\"\"]">
											...
											<#if endhour?has_content && endhour?? && endhour != "[\"\"]">
		...
		<#if ehucommunicationinformation?? >
			...
			<#if comunicationType?? && (comunicationType != "") && comunicationType != "upv-ehu-blank"   >
