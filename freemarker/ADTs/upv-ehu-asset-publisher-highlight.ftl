                        ...
                        <#if ddmStructure?? > 
                            ...
                            <#if (ddmTemplateKey != 0)>
								...
								<div class="box">	
									...
									<#if journalArticleLocalService.fetchJournalArticle(assetObject.getId())??>
										${journalArticleLocalService.getArticleContent(assetObject, ddmTemplateKeyStr,"VIEW", locale, null, themeDisplay)}	
									</#if>							
	                                </a>
	                            </div>
                            <#else>    
