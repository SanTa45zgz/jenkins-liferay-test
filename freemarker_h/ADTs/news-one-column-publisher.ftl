...
<#if themeDisplay.getTheme().getContextPath() == "/o/upv-ehu-global-theme">
    ...
    <#else>
        <div class="news-one-column-publisher">
            <div class="news-one-column-publisher__list">
                ...
                <#if entries?has_content>
                    ...
                    <#list entries as curEntry>
                        ...
                        <div class="news-one-column-publisher__list__item">
                        
                            <div class="news-one-column-publisher__list__item__image">
                            ...
                            <div>
                                <#if title?has_content>
                                    <a href="${viewURL}"><p class="news-one-column-publisher__list__item__title u-text-truncate u-text-truncate--3">${title}</p></a>
                                </#if>
                            </div>
                        </div>
