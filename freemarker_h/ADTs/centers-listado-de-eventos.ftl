<#--
Centros - Listado de eventos
https://dev74.ehu.eus/es/web/bilboko-ingeniaritza-eskola
Nota: solo se usa con global-theme. Listado de eventos para home de centros (al dar a mostrar más hay otro publicador con esta ADT)
-->
