...
Nota: la ha tocado Zylk porque también se usa en Campusa 
    (aparte se usa en ehu-theme y en global-theme, aunque ahí solo se debería usar con contenidos tipo Persona)
  -->
<#if themeDisplay.getTheme().getContextPath() == "/o/upv-ehu-global-theme">
    ...
    <#else>
        <div class="news-two-column-publisher">
            <div class="news-two-column-publisher__list row">
                ...
                <#if entries?has_content>
                    ...
                    <#assign
                        counter = 1
                        columElements = entries?size/2
                    />
                    <#if entries?size%2!=0>
                        <#assign columElements = columElements?round/>
                    </#if>
                    <#list entries as curEntry>
                                ...
                                <#list field.getNestedDDMFormFieldValues() as nestedValue>
                                    <#if nestedValue?? && nestedValue.getValue()?? &&  nestedValue.getValue()?has_content>
                                        ...
                                        <#if structureName == "Ekitaldia">
                                            ...
                                            <#if nestedValue.getName()=="ehudescription">
                        ...
                        <#if curEntry?is_first || counter == columElements+1>
                            <div class="col-12 col-lg-6">
                        </#if>
                            <div class="news-two-column-publisher__list__item">
                            
                                <div class="news-two-column-publisher__list__item__image">
                                ...
                                <div>
                                    <#if title?has_content>
                                        <a href="${viewURL}"><p class="news-two-column-publisher__list__item__title u-text-truncate u-text-truncate--3">${title}</p></a>
                                    </#if>
                                </div>
                            </div>
                        
                        <#if curEntry?is_last || counter == columElements>
                            </div>
                        </#if>
                        <#assign counter++/>
                    </#list>
