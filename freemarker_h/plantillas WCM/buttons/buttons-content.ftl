<#--  
Nombre contenido (ES): Botones
https://dev74.ehu.eus/es/web/master/master-ingenieria-mecanica/matricula
Estructura: global > buttons.json
Plantilla:Botones
    ...
    <#else>
		<div class="buttons-content">
			...
			<div class="buttons-content__documents-links">
				<ul>
					<#if ehuattachments.ehuinfoattachmentdocument?has_content>
				    ...
				    <#if ehuattachments.ehuinfoattachmenturl?has_content>
