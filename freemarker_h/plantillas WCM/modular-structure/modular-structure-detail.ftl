<#--
Nombre contenido (ES): Estructura modular
Estructura: graduondokoak > modular-structure.json
Plantilla (ES): Contenido Completo
URL: https://dev74.ehu.eus/es/web/graduondokoak/master-gestion-deporte/estructura-modular
Nota: Solo se usa con global-theme > master (en dev74 hay otra plantilla de "Contenido completo Simple" pero no hay que tenerla en cuenta porque en prod de 7.2 esa plantilla está eliminada)
-->
