 ...
 *
 * UPV/EHU
 * Mostrar sólo 100 caracteres de descripción puede que no sea suficiente (línea 242)
 * pasa de StringUtil.shorten(fileEntry.getDescription(), 100)
 */
--%>
								...
								<c:choose>
									...
									<c:when test='<%= curEntryColumn.equals("description") %>'>
										<liferay-ui:search-container-column-text
											cssClass="table-cell-expand table-cell-minw-200"
											name="description"
											value="<%= fileEntry.getDescription() %>"
										/>
									</c:when> 
