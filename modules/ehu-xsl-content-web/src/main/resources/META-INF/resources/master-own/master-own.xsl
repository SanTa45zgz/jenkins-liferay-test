...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:include href="http://localhost:8080/o/ehu-xsl-content-web/master-own/master-own-templates.xsl"/>
	...
	<!-- Variables ya definidas en common.xsl 
