package es.ehu.doc.web.cmistemplate.portlet.route;
...
@Component(
	immediate = true,
     property = {
         "com.liferay.portlet.friendly-url-routes=META-INF/friendly-url-routes/routes-doc-template.xml",
         "javax.portlet.name=" + DocWebConstants.DOC_CMISTEMPLATE_PORTLET
     },
     service = FriendlyURLMapper.class
 )
public class CmisTemplateFriendlyURLMapper extends DefaultFriendlyURLMapper{
	 ...
	 /*
	    ...
	    private static final String _MAPPING = DocWebConstants.CMISTEMPLATE_FRIENDLY_URL_MAPPING;
}
